...
const PLANS = [
  {
    ...
    price: 'R$ 0',
    period: '',
    detail: '7 dias · Acesso Premium completo',
    cta: 'Começar grátis',
    highlight: false,
    badge: null,
    features: ['Todos os professores liberados', 'Teste de nivelamento por IA', 'Avaliação de pronúncia', 'Dashboard completo'],
  },
  {
    name: 'Básico',
    price: 'R$ 39,90',
    period: '/mês',
    detail: 'Crie uma rotina consistente.',
    cta: 'Assinar Básico',
    highlight: false,
    badge: null,
    features: ['~10 min por dia', 'Plano de estudos personalizado', 'Histórico completo', 'Memória entre sessões'],
  },
  {
    name: 'Pro',
    price: 'R$ 79,90',
    period: '/mês',
    detail: 'Acelere sua fluência.',
    cta: 'Assinar Pro',
    highlight: true,
    badge: 'Mais Popular',
    features: ['~20-30 min por dia', 'Tudo do Básico', 'Avaliação de pronúncia', 'Missões diárias personalizadas', 'Plano adaptado pela IA'],
  },
  {
    name: 'Anual',
    price: 'R$ 599,90',
    period: '/ano',
    detail: 'Sua jornada completa rumo à fluência.',
    cta: 'Assinar Anual',
    highlight: false,
    badge: 'Melhor Valor',
